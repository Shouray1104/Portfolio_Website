        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                Focused on creating seamless user experiences with clean, maintainable code.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Designing efficient system architectures and solving complex problems with data structures and algorithms.
                Passionate about building robust, scalable solutions following software engineering best practices.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
